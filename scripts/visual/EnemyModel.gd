...
func _build_humanoid(scale_factor: float, armor: bool, cloth: Material):
	...
	_limb(body_root, "ArmL", Vector3(-0.34, 1.26, 0), 0.72, 0.105, cloth, Vector3(0, 0, -5))
	_limb(body_root, "ArmR", Vector3(0.34, 1.26, 0), 0.72, 0.105, cloth, Vector3(0, 0, 5))
	_limb(body_root, "LegL", Vector3(-0.15, 0.54, 0), 0.92, 0.13, VisualLibrary.material("leather"))
	_limb(body_root, "LegR", Vector3(0.15, 0.54, 0), 0.92, 0.13, VisualLibrary.material("leather"))
